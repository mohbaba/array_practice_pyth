...
public class EvenPositionTest{
	...
	public void testIntEvenPositionChecker(){
		...
		assertArrayEquals(expected, evenPositionChecker.intPositionChecker(array));
	...
	public void testStringPositionChecker(){
		...
		assertArrayEquals(expected, evenPositionChecker.stringPositionChecker(array));
	...
	public void testObjectPositionChecker(){
	 ...
	 assertArrayEquals(expected,evenPositionChecker.objectPositionChecker(array));
